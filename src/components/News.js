    ...
    render() {
        return (
            <div className='container'>
                <h2>NewsTime - Top Headlines</h2>
                <div className="row">
                    <div className="col">
                        <NewsItem title="Bye-bye bots: Altera's game-playing AI agents get backing from Eric Schmidt | TechCrunch" description="Autonomous, AI-based players are coming to a gaming experience near you, and a new startup, Altera, is joining the fray to build this new guard of AI Research company Altera raised $9 million to build AI agents that can play video games alongside other player…" imgUrl="https://techcrunch.com/wp-content/uploads/2024/05/ipad-noplay.png?resize=1200,675" />
                    </div>
                    <div className="col">
                        <NewsItem title="Bye-bye bots: Altera's game-playing AI agents get backing from Eric Schmidt | TechCrunch" description="Autonomous, AI-based players are coming to a gaming experience near you, and a new startup, Altera, is joining the fray to build this new guard of AI Research company Altera raised $9 million to build AI agents that can play video games alongside other player…" imgUrl="https://techcrunch.com/wp-content/uploads/2024/05/ipad-noplay.png?resize=1200,675" />
                    </div>
